...
HD_PWD='/nfs/nfs2/home/mawlorch/Project_5/Project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_2_4.tcl -notrace
